...
REM
REM USAGE:
REM 	Packet.DownloadInstall.bat
REM
REM ***************************************************************************
@echo off
rem Данный скрипт скачивает дистрибутив 'Packet' с сайта, описание которого 
...
if exist "%LocalFolder%\%Distributive%" (
    echo The File Packet is Present. Deleting It
...
rem Check Presence of Packet
if not exist "%LocalFolder%\%Distributive%" goto pass_Program

rem Uninstall Packet !!! CHANGED VALUE !!!
rem echo "Uninstall Packet..."
rem %SystemRoot%\System32\WBEM\wmic.exe product where name="Packet Name" call uninstall
rem Install Packet !!! CHANGED VALUE !!!
echo "Install Packet..."
