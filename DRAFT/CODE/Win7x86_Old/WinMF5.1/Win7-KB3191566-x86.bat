REM ***************************************************************************
REM
REM Win7-KB3191566-x86.msu DISTRIBUTIVE Download and Install
REM
REM USAGE:
REM 	Win7-KB3191566-x86.msu.DownloadInstall.bat
REM
REM ***************************************************************************
@echo off
rem Данный скрипт скачивает дистрибутив 'Win7-KB3191566-x86.msu' с сайта, описание которого
...
set Distributive=Win7-KB3191566-x86.msu
...
if exist "%LocalFolder%\%Distributive%" (
    echo The File Win7-KB3191566-x86.msu is Present. Deleting It
...
rem Check Presence of Win7-KB3191566-x86.msu
if not exist "%LocalFolder%\%Distributive%" goto pass_Program

rem Uninstall Win7-KB3191566-x86.msu !!! CHANGED VALUE !!!
rem echo "Uninstall Win7-KB3191566-x86.msu..."
rem %SystemRoot%\System32\WBEM\wmic.exe product where name="Win7-KB3191566-x86.msu Name" call uninstall
rem Install Win7-KB3191566-x86.msu !!! CHANGED VALUE !!!
echo "Install Win7-KB3191566-x86.msu..."
