REM ***************************************************************************
REM
REM Windows6.1-KB2639308-x86.msu DISTRIBUTIVE Download and Install
REM
REM USAGE:
REM 	Windows6.1-KB2639308-x86.bat
REM
REM ***************************************************************************
@echo off
rem Данный скрипт скачивает дистрибутив 'Windows6.1-KB2639308-x86.msu' с сайта, описание которого
...
set Distributive=Windows6.1-KB2639308-x86.msu
...
if exist "%LocalFolder%\%Distributive%" (
    echo The File Windows6.1-KB2639308-x86.msu is Present. Deleting It
...
rem Check Presence of Windows6.1-KB2639308-x86.msu
if not exist "%LocalFolder%\%Distributive%" goto pass_Program

rem Uninstall Windows6.1-KB2639308-x86.msu !!! CHANGED VALUE !!!
rem echo "Uninstall Windows6.1-KB2639308-x86.msu..."
rem %SystemRoot%\System32\WBEM\wmic.exe product where name="Windows6.1-KB2639308-x86.msu Name" call uninstall
rem Install Windows6.1-KB2639308-x86.msu !!! CHANGED VALUE !!!
echo "Install Windows6.1-KB2639308-x86.msu..."
