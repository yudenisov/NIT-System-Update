REM ***************************************************************************
REM
REM EIE11_RU-RU_WOL_WIN764.EXE DISTRIBUTIVE Download and Install
REM
REM USAGE:
REM 	EIE11_RU-RU_WOL_WIN764.bat
REM
REM ***************************************************************************
@echo off
rem Данный скрипт скачивает дистрибутив 'EIE11_RU-RU_WOL_WIN764.EXE' с сайта, описание которого 
...
set Distributive=EIE11_RU-RU_WOL_WIN764.EXE
...
if exist "%LocalFolder%\%Distributive%" (
    echo The File EIE11_RU-RU_WOL_WIN764.EXE is Present. Deleting It
...
rem Check Presence of EIE11_RU-RU_WOL_WIN764.EXE
if not exist "%LocalFolder%\%Distributive%" goto pass_Program

rem Uninstall EIE11_RU-RU_WOL_WIN764.EXE !!! CHANGED VALUE !!!
rem echo "Uninstall EIE11_RU-RU_WOL_WIN764.EXE..."
rem %SystemRoot%\System32\WBEM\wmic.exe product where name="EIE11_RU-RU_WOL_WIN764.EXE Name" call uninstall
rem Install EIE11_RU-RU_WOL_WIN764.EXE !!! CHANGED VALUE !!!
echo "Install EIE11_RU-RU_WOL_WIN764.EXE..."
