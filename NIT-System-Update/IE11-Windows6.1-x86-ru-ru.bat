REM ***************************************************************************
REM
REM IE11-Windows6.1-x86-ru-ru.exe DISTRIBUTIVE Download and Install
REM
REM USAGE:
REM 	IE11-Windows6.1-x86-ru-ru.bat
REM
REM ***************************************************************************
@echo off
rem Данный скрипт скачивает дистрибутив 'IE11-Windows6.1-x86-ru-ru.exe' с сайта, описание которого 
...
set Distributive=IE11-Windows6.1-x86-ru-ru.exe
...
if exist "%LocalFolder%\%Distributive%" (
    echo The File IE11-Windows6.1-x86-ru-ru.exe is Present. Deleting It
...
rem Check Presence of IE11-Windows6.1-x86-ru-ru.exe
if not exist "%LocalFolder%\%Distributive%" goto pass_Program

rem Uninstall IE11-Windows6.1-x86-ru-ru.exe !!! CHANGED VALUE !!!
rem echo "Uninstall IE11-Windows6.1-x86-ru-ru.exe..."
rem %SystemRoot%\System32\WBEM\wmic.exe product where name="IE11-Windows6.1-x86-ru-ru.exe Name" call uninstall
rem Install IE11-Windows6.1-x86-ru-ru.exe !!! CHANGED VALUE !!!
echo "Install IE11-Windows6.1-x86-ru-ru.exe..."
