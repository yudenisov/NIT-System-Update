...
REM
REM USAGE:
REM 	dotNetFx40_Full_x86_x64.bat
REM
REM ***************************************************************************
@echo off
rem Данный скрипт скачивает дистрибутив 'dotNetFx40_Full_x86_x64.exe' с сайта, описание которого 
...
set Distributive=dotNetFx40_Full_x86_x64.exe
...
if exist "%LocalFolder%\%Distributive%" (
    echo The File dotNetFx40_Full_x86_x64.exe is Present. Deleting It
...
rem Check Presence of dotNetFx40_Full_x86_x64.exe
if not exist "%LocalFolder%\%Distributive%" goto pass_Program

rem Uninstall dotNetFx40_Full_x86_x64.exe !!! CHANGED VALUE !!!
rem echo "Uninstall dotNetFx40_Full_x86_x64.exe..."
rem %SystemRoot%\System32\WBEM\wmic.exe product where name="dotNetFx40_Full_x86_x64.exe Name" call uninstall
rem Install dotNetFx40_Full_x86_x64.exe !!! CHANGED VALUE !!!
echo "Install dotNetFx40_Full_x86_x64.exe..."
