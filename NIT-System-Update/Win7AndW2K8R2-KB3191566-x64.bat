...
REM ***************************************************************************
@echo off
rem Данный скрипт скачивает дистрибутив 'Win7AndW2K8R2-KB3191566-x64.msu' с сайта, описание которого 
...
set Distributive=Win7AndW2K8R2-KB3191566-x64.msu
...
if exist "%LocalFolder%\%Distributive%" (
    echo The File Win7AndW2K8R2-KB3191566-x64.msu is Present. Deleting It
