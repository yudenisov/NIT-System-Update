REM ***************************************************************************
REM
REM W2K12-KB3191565-x64.msu DISTRIBUTIVE Download and Install
REM
REM USAGE:
REM 	W2K12-KB3191565-x64.bat
REM
REM ***************************************************************************
@echo off
rem Данный скрипт скачивает дистрибутив 'W2K12-KB3191565-x64.msu' с сайта, описание которого
...
set Distributive=W2K12-KB3191565-x64.msu
...
if exist "%LocalFolder%\%Distributive%" (
    echo The File W2K12-KB3191565-x64.msu is Present. Deleting It
...
rem Check Presence of W2K12-KB3191565-x64.msu
if not exist "%LocalFolder%\%Distributive%" goto pass_Program

rem Uninstall W2K12-KB3191565-x64.msu !!! CHANGED VALUE !!!
rem echo "Uninstall W2K12-KB3191565-x64.msu..."
rem %SystemRoot%\System32\WBEM\wmic.exe product where name="W2K12-KB3191565-x64.msu Name" call uninstall
rem Install W2K12-KB3191565-x64.msu !!! CHANGED VALUE !!!
echo "Install W2K12-KB3191565-x64.msu..."
