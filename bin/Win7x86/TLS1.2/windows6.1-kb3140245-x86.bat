REM ***************************************************************************
REM
REM windows6.1-kb3140245-x64.msu DISTRIBUTIVE Download and Install
REM
REM USAGE:
REM 	windows6.1-kb3140245-x64.bat
REM
REM ***************************************************************************
@echo off
rem Данный скрипт скачивает дистрибутив 'windows6.1-kb3140245-x64.msu' с сайта, описание которого
