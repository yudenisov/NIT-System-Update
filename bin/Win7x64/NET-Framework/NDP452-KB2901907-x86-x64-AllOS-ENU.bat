...
REM
REM USAGE:
REM 	NDP452-KB2901907-x86-x64-AllOS-ENU.bat
REM
REM ***************************************************************************
@echo off
rem Данный скрипт скачивает дистрибутив 'NDP452-KB2901907-x86-x64-AllOS-ENU.exe' с сайта, описание которого
...
if exist "%LocalFolder%\%Distributive%" (
    echo The File %~n0.exe is Present. Deleting It
...
rem Check Presence of NDP452-KB2901907-x86-x64-AllOS-ENU.exe
if not exist "%LocalFolder%\%Distributive%" goto pass_Program

rem Uninstall NDP452-KB2901907-x86-x64-AllOS-ENU.exe !!! CHANGED VALUE !!!
rem echo "Uninstall NDP452-KB2901907-x86-x64-AllOS-ENU.exe..."
rem %SystemRoot%\System32\WBEM\wmic.exe product where name="NDP452-KB2901907-x86-x64-AllOS-ENU.exe Name" call uninstall
rem Install NDP452-KB2901907-x86-x64-AllOS-ENU.exe !!! CHANGED VALUE !!!
echo "Install NDP452-KB2901907-x86-x64-AllOS-ENU.exe..."
