...
if not exist "%curdirforurl%windows6.1-kb4019990-x64.bat" goto passHW001
call "%curdirforurl%windows6.1-kb4019990-x64.bat" || exit /b 1
:passHW001

if not exist "%curdirforurl%Win7AndW2K8R2-KB3191566-x64.bat" goto passHW002
