REM ***************************************************************************
REM
REM Win8.1AndW2K12R2-KB3191564-x64.msu DISTRIBUTIVE Download and Install
REM
REM USAGE:
REM 	Win8.1AndW2K12R2-KB3191564-x64.bat
REM
REM ***************************************************************************
@echo off
rem Данный скрипт скачивает дистрибутив 'Win8.1AndW2K12R2-KB3191564-x64.msu' с сайта, описание которого
...
set Distributive=Win8.1AndW2K12R2-KB3191564-x64.msu
...
if exist "%LocalFolder%\%Distributive%" (
    echo The File Win8.1AndW2K12R2-KB3191564-x64.msu is Present. Deleting It
...
rem Check Presence of Win8.1AndW2K12R2-KB3191564-x64.msu
if not exist "%LocalFolder%\%Distributive%" goto pass_Program

rem Uninstall Win8.1AndW2K12R2-KB3191564-x64.msu !!! CHANGED VALUE !!!
rem echo "Uninstall Win8.1AndW2K12R2-KB3191564-x64.msu..."
rem %SystemRoot%\System32\WBEM\wmic.exe product where name="Win8.1AndW2K12R2-KB3191564-x64.msu Name" call uninstall
rem Install Win8.1AndW2K12R2-KB3191564-x64.msu !!! CHANGED VALUE !!!
echo "Install Win8.1AndW2K12R2-KB3191564-x64.msu..."
